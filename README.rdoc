...
BracketNotation is a library for parsing strings that have been marked up with
labeled-bracket notation, of the kind commonly used as short hand for trees when
discussing sentence structure. It generates an abstract tree representation of
the parsed sentence, suitable for use in any number of applications.
